...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamento)\n/* harmony export */ });\nfunction initFuncionamento() {\n  var funcionamento = document.querySelector(\"[data-semana]\");\n  var diasSemana = funcionamento.dataset.semana.split(\", \").map(Number); //Ao passar o split a string se torna Array, e passando o map(Number) retorna uma nova Array, porém com os valores em number\n  var horarioSemana = funcionamento.dataset.horario.split(\", \").map(Number);\n  var dataAgora = new Date();\n  var diaAgora = dataAgora.getDay();\n  var horaAgora = dataAgora.getHours();\n  var semanaAberto = diasSemana.indexOf(diaAgora) !== -1; //se um elemento nao está na Array retorna-se -1;\n  var horaAberto = horaAgora >= horarioSemana[0] && horaAgora < horarioSemana[1];\n  if (semanaAberto && horaAberto) {\n    funcionamento.classList.add(\"aberto\");\n  }\n}\nvar agora = new Date();\nvar futuro = new Date(\"Dec 24 2025\");\nfunction transformarHoras(tempo) {\n  return tempo / (24 * 60 * 60 * 1000); //transformando ms para dias\n}\nvar diasAgora = transformarHoras(agora.getTime()); //ms de 1970 até agora\nvar diasFuturo = transformarHoras(futuro.getTime());\nconsole.log(Math.floor(diasFuturo) - Math.floor(diasAgora));\n\n//# sourceURL=webpack://animaisfantasticos/./js/modules/funcionamento.js?");
